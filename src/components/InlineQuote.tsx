...
const InlineQuote: React.FC = () => {
  return (
    <div style={{ background: 'var(--cream)', padding: '40px 0', borderTop: '1px solid var(--rule)', borderBottom: '1px solid var(--rule)' }}>
        ...
        <div className="reveal" style={{ maxWidth: '1000px', margin: '0 auto', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '40px' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start', gap: '6px' }}>
            ...
            <div style={{ fontSize: '11px', color: 'var(--muted)', fontWeight: 500 }}>
              Verified on <span style={{ color: '#0d47a1', fontWeight: 700 }}>Clutch</span>
            </div>
          </div>
